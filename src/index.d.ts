// Type definitions for svelte-window
// Definitions by: Michael Lucht <https://github.com/micha-lmxt>
//                 
// original: 
...
export type ListItemKeySelector = (index: number, data: any) => string | number;
 ...
 * </FixedSizeList>  
 */
export class FixedSizeList extends SvelteComponentTyped<FixedSizeListProps, {}, {
    default: { items: ListChildComponentProps[] };
}> {
    /**
 ...
 * </VariableSizeList> * 
 */
export class VariableSizeList extends SvelteComponentTyped<VariableSizeListProps, {}, {
    default: { items: ListChildComponentProps[] };
}> {
    /**
     * Scroll to the specified offset (scrollTop or scrollLeft, depending on the direction prop).
 ...
 * </FixedSizeGrid> * 
 */
export class FixedSizeGrid extends SvelteComponentTyped<FixedSizeGridProps, {}, {
    default: { items: GridChildComponentProps[] };
}> {
    /**
 ...
 * </VariableSizeGrid> * 
 */
export class VariableSizeGrid extends SvelteComponentTyped<VariableSizeGridProps, {}, {
    default: { items: GridChildComponentProps[] };
}> {
    /**
     * Scroll to the specified offsets.
...
export function styleString(styleObject:StyleObject) : string;